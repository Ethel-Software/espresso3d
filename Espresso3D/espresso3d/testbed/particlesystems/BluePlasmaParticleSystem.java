 ...
 */
public class BluePlasmaParticleSystem extends E3DParticleSystem {

    public BluePlasmaParticleSystem(E3DEngine engine) throws Exception
    {
        super(engine);
		for(int i=0; i<75; i++)
		{
    ...
    public BluePlasmaParticleSystem(BluePlasmaParticleSystem toCopySystem)
    {
        super(toCopySystem);
    }
    ...
    public E3DParticleSystem onGetClone() throws Exception {
        BluePlasmaParticleSystem copied = new BluePlasmaParticleSystem(this);
        return copied;
    }
