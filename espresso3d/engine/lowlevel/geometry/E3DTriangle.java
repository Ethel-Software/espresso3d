...
{
	private E3DRenderable parentObject; //could be an actor, etc.
	...
	public E3DTriangle(E3DEngine engine)
	{
        ...
        vertices[0] = new E3DTexturedVertex(engine, new E3DVector3F(0.0, 0.0, 0.0),
                                                    new E3DVector4F(1.0, 1.0, 1.0, 1.0),
                                                    new E3DVector2F(0.0, 0.0));
        vertices[1] = new E3DTexturedVertex(engine, new E3DVector3F(0.0, 0.0, 0.0),
                                                    new E3DVector4F(1.0, 1.0, 1.0, 1.0),
                                                    new E3DVector2F(0.0, 0.0));
        vertices[2] = new E3DTexturedVertex(engine, new E3DVector3F(0.0, 0.0, 0.0),
                                                    new E3DVector4F(1.0, 1.0, 1.0, 1.0),
                                                    new E3DVector2F(0.0, 0.0));
	...
	public E3DTriangle(E3DEngine engine, E3DVector3F vertexPosA, E3DVector3F vertexPosB, E3DVector3F vertexPosC,
			E3DVector2F texCoordA, E3DVector2F texCoordB, E3DVector2F texCoordC, String textureName)
	{
    ...
    public E3DTriangle(E3DEngine engine, E3DVector3F vertexPosA, E3DVector3F vertexPosB, E3DVector3F vertexPosC,
            E3DVector2F texCoordA, E3DVector2F texCoordB, E3DVector2F texCoordC, String textureName,
            E3DVector2F detail0TexCoordA, E3DVector2F detail0TexCoordB,E3DVector2F detail0TexCoordC, String detail0TextureName)
    {
    ...
    public E3DTriangle(E3DEngine engine, E3DVector3F vertexPosA, E3DVector3F vertexPosB, E3DVector3F vertexPosC,
            E3DVector2F texCoordA, E3DVector2F texCoordB, E3DVector2F texCoordC, String textureName,
            E3DVector2F detail0TexCoordA, E3DVector2F detail0TexCoordB,E3DVector2F detail0TexCoordC, String detail0TextureName,
            E3DVector2F detail1TexCoordA, E3DVector2F detail1TexCoordB,E3DVector2F detail1TexCoordC, String detail1TextureName)
    {
...
//        vertices[0].getVertexPos().appendToBuffer(buffer);
//        vertices[1].getVertexPos().appendToBuffer(buffer);
//        vertices[2].getVertexPos().appendToBuffer(buffer);
    ...
    {
//        vertices[0].getVertexColor().appendToBuffer(buffer);
//        vertices[1].getVertexColor().appendToBuffer(buffer);
//        vertices[2].getVertexColor().appendToBuffer(buffer);        
    ...
    {
//        vertices[0].getTextureCoord().appendToBuffer(buffer);
//        vertices[1].getTextureCoord().appendToBuffer(buffer);
//        vertices[2].getTextureCoord().appendToBuffer(buffer);        
...
//        vertices[0].getTextureCoordDetail0().appendToBuffer(buffer);
//        vertices[1].getTextureCoordDetail0().appendToBuffer(buffer);
//        vertices[2].getTextureCoordDetail0().appendToBuffer(buffer);        
...
//        vertices[0].getTextureCoordDetail1().appendToBuffer(buffer);
//        vertices[1].getTextureCoordDetail1().appendToBuffer(buffer);
//        vertices[2].getTextureCoordDetail1().appendToBuffer(buffer);        
	...
	public E3DVector3F getCentroid()
	{
        ...
        E3DVector3F retVec = new E3DVector3F(vertexPosA.getX() + vertexPosB.getX() + vertexPosC.getX(),
                                             vertexPosA.getY() + vertexPosB.getY() + vertexPosC.getY(),
                                             vertexPosA.getZ() + vertexPosB.getZ() + vertexPosC.getZ());
		retVec.scaleEqual(0.33333333); //Approximation
	...
	private void recalculatePlaneEquationCoords()
	{
		...
		setPlaneEquationCoords(new E3DVector4F(normal.getX(), 
							  normal.getY(), 
							  normal.getZ(), 
							  -normal.dotProduct(getVertexA().getVertexPos())));
...
/*        
    ...
    {
    	if(arg0 == null || !(arg0 instanceof E3DTriangle))
    		return false;
    	return arg0 == this;
