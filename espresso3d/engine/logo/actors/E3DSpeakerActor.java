 ...
 */
public class E3DSpeakerActor extends E3DActor 
{
    public E3DSpeakerActor(E3DEngine engine, E3DWorld world, String actorID)
    {
        super(engine, world, actorID);
    
        try{
            loadActor("/espresso3d/engine/logo/models/speaker.e3a");
        }catch(Exception e){
            e.printStackTrace();
            return;
