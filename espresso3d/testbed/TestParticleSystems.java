 ...
 */
public class TestParticleSystems implements ITestBed {
	...
	public static void main(String[] args) {
		TestParticleSystems testBed = new TestParticleSystems(); //Create an instance of the PongClone class
		try{
...
//			i++;
//			if(i == 100)
//				engine.getCurrentViewport().getCameraActor().getSector().removeParticleSystem((E3DParticleSystem)engine.getCurrentViewport().getCameraActor().getSector().getParticleSystemList().get(2));
