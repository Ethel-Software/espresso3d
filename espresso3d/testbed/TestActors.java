 ...
 */
public class TestActors implements ITestBed {
	...
	public static void main(String[] args) {
		TestActors testBed = new TestActors(); //Create an instance of the PongClone class
		try{
...
//		E3DSector sector2 = world.getSector("sector2");  //Grab our main sector.
	...
	private void gameLoop() throws Exception
	{
		...
		animatedBall.getSkeleton().startAnimation("test", -1);
//		((E3DTriangle)animatedBall.getMesh().getTriangleList().get(0)).setTexture(getEngine().getTexture("WALL"));
//		((E3DTriangle)animatedBall.getMesh().getTriangleList().get(1)).setTexture(getEngine().getTexture("WALL"));
//		((E3DTriangle)animatedBall.getMesh().getTriangleList().get(2)).setTexture(getEngine().getTexture("WALL"));
//		((E3DTriangle)animatedBall.getMesh().getTriangleList().get(3)).setTexture(getEngine().getTexture("WALL"));
//		((E3DTriangle)animatedBall.getMesh().getTriangleList().get(4)).setTexture(getEngine().getTexture("WALL"));
//		((E3DTriangle)animatedBall.getMesh().getTriangleList().get(5)).setTexture(getEngine().getTexture("WALL"));
//		((E3DTriangle)animatedBall.getMesh().getTriangleList().get(6)).setTexture(getEngine().getTexture("WALL"));
//		((E3DTriangle)animatedBall.getMesh().getTriangleList().get(7)).setTexture(getEngine().getTexture("WALL"));
