...
import espresso3d.engine.window.gui.window.E3DGuiWindowVariableSize;
 ...
 */
public class TestGUI implements ITestBed {
	...
	public static void main(String[] args) {
		TestGUI testBed = new TestGUI(); //Create an instance of the PongClone class
		try{
	...
	public void initGUI()
	{
		E3DGuiHandler handler = engine.getWindow().getGuiHandler();
		
		E3DGuiWindowVariableSize dialog = new E3DGuiWindowVariableSize(engine, "window1", "Hello",
				10, 10, 75, 75, new E3DRenderMode(engine, E3DRenderMode.RENDERMODE_SOLID), 
				new E3DBlendMode(engine, E3DBlendMode.BLENDMODE_SOLID));
		handler.addGuiWindow(dialog);
	}
