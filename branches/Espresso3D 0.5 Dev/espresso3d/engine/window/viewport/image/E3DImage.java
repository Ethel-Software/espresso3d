 ...
 */
abstract public class E3DImage extends E3DAnimatedTextureRenderable implements IE3DHashableNode
{
	...
	public E3DImage(E3DEngine engine, String imageID, String textureName, E3DVector2I position, int life, E3DBlendMode blendMode)
	{
		...
		quad = new E3DQuad(getEngine(), new E3DVector3F(-0.5, -0.5, 0), 
                ...
                new E3DVector2F(0, 1), 
                new E3DVector2F(1, 1), 
                new E3DVector2F(1, 0), getAnimatedTexture().getTextureName());
	}
...
/*        quad = new E3DQuad(getEngine(), new E3DVector3F(-0.5, -0.5, 0), 
  ...
  */      
        quad = new E3DQuad(getEngine(), 
                ...
                new E3DVector2F(0, 1), 
                new E3DVector2F(0, 0), 
                getAnimatedTexture().getTextureName());
	}
     ...
     * @return
     */
    abstract public E3DQuad getPositionedQuad();
...
//        if(super.getAnimatedTexture().update(lastFrameTimeSeconds)) //update the animated texture
 //           setTexture(getAnimatedTexture());
    ...
    public void setTexture(E3DTexture texture) {
        ...
        if(viewport != null)
        	viewport.getRenderTree().getImageHandler().rehash(this);
    }
